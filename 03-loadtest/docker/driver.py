...
# python driver.py --host https://uoykcmsezg.execute-api.ap-southeast-1.amazonaws.com --shapes-bucket ml-serving-perftest --shapes-key _data/load-test/shape.json
# python driver.py --client-type master --expected-workers 1 --host https://uoykcmsezg.execute-api.ap-southeast-1.amazonaws.com --shapes-bucket ml-serving-perftest --shapes-key _data/load-test/shape.json
# python driver.py --client-type worker --host https://uoykcmsezg.execute-api.ap-southeast-1.amazonaws.com --shapes-bucket ml-serving-perftest --shapes-key _data/load-test/shape.json

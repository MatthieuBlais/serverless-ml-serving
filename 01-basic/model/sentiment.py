...
def train(current_host, hosts, num_cpus, num_gpus, training_dir, model_dir,
    ...
    train_sentences, train_labels, _ = get_dataset(training_dir + '/train.csv', train=True)
    val_sentences, val_labels, _ = get_dataset(training_dir + '/test.csv', train=False)
